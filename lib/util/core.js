define(function () {
    ...
    /** alise of: util.Function.memoize
     ...
     **/
    var functionMemoise = function (func, resolver) {
    ...
    // Taken from lodash.
    var stringToPath = function functionMemoise(function (string) {

        var result = [];
        var str = stringInterpret(string);
    ...
    var objectAccess = function (object, path) {
        ...
        stringToPath(path).every(function (pathPart) {

            object = (object && owns(object, property))
                ? object[property]
                : undefined;
    ...
    assign(core, {
        ...
        functionMemoise: functionMemoise,
        getType: getType,
        identity: identity,
